...
impl Aggregate<OnlineStats, Option<f64>> for Stddev {
    ...
    fn step(&self, ctx: &mut Context<'_>, stdev: &mut OnlineStats) -> Result<()> {
        ...
        match value {
            ...
            ValueRef::Text(_) | ValueRef::Blob(_) => { return Result::Err(rusqlite::Error::UserFunctionError("can't take stddev of this value".into())); }
        }
        Ok(())
    }
...
impl Aggregate<OnlineStats, Option<f64>> for Mean {
    ...
    fn step(&self, ctx: &mut Context<'_>, mean: &mut OnlineStats) -> Result<()> {
        ...
        match value {
            ...
            ValueRef::Text(_) | ValueRef::Blob(_) => { return Result::Err(rusqlite::Error::UserFunctionError("can't take mean of this value".into())); }
        }
        Ok(())
    }
